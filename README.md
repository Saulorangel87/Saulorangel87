...
Sou um **desenvolvedor Frontend** apaixonado por criar experiências web incríveis, com objetivo de me especializar em **Full Stack Development**. Aqui você encontra meus projetos, contribuições e jornada no desenvolvimento.

---

## 🎯 Sobre Mim

- 🔭 Atualmente focado em **Frontend Development** com React
- 🚀 Me especializando em **Full Stack** (Frontend + Backend)
- 💻 Criando soluções web responsivas e performáticas
...
Confira meus repositórios fixados abaixo! Neles você encontra projetos desenvolvidos com as melhores práticas de código limpo e documentação clara.
