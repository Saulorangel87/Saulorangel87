...
Desenvolvedor Frontend em transição para Full Stack, movido pela curiosidade e pelo desejo de criar soluções que causem impacto real.

## Minha Jornada
* **Trajetória:** Com 13 anos de experiência nos Correios, atuo atualmente como carteiro motorizado.
* **Projetos:** Estou desenvolvendo uma aplicação web para digitalização e otimização de rotas, visando modernizar o processo atual da empresa, que ainda utiliza mapas em papel.
* **Formação:** Estudante do 2º semestre de Análise e Desenvolvimento de Sistemas (ADS) na Estácio de Sá.

Sou apaixonado por tecnologia desde a infância e, hoje, aplico essa paixão no desenvolvimento de aplicações eficientes. Estou sempre aberto a novos desafios e aprendizados.
...
Estou em uma jornada de crescimento contínuo:
...
**Feito por Saulo Rangel** | Se gostou de algo por aqui, considere dar uma ⭐ nos repositórios!
